...
var getOneBlog = function getOneBlog() {
  return $.ajax({
    url: config.apiOrigin + '/contents',
    method: 'GET'
  });
...
var onViewOneBlog = function onViewOneBlog(event) {
  ...
  event.preventDefault();
  api.getOneBlog().then(ui.getOneBlogSuccess).catch(ui.getOneBlogFailure);
};
...
var getOneBlogSuccess = function getOneBlogSuccess(data) {
  var matchingEntries = data.contents.filter(function (content) {
    return content._owner === store.userid;
  });
...
var getPostsSuccess = function getPostsSuccess(data) {
  ...
  var showContentHTML = showContent({ contents: matchingPosts });
...
var onSavePost = function onSavePost(id, title, date, text, type) {
  ...
  title.remove();
  text.remove();
  api.updateContent(data, id).then(updatePostSuccess).catch(updatePostFailure);
};
...
var getPagesSuccess = function getPagesSuccess(data) {
  ...
  var showContentHTML = showContent({ contents: matchingPages });
...
var onSavePage = function onSavePage(id, title, date, text, type) {
  ...
  title.remove();
  text.remove();
  api.updateContent(data, id).then(updatePageSuccess).catch(updatePageFailure);
};
